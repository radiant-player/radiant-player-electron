...
export class MiniplayerVolume extends Component {
    ...
    VolumeStatus(percent) {
        let vol = window.document.querySelector(`[class*='${miniplayer.menu_vol}'] path`);
    ...
    render() {
        ...
        const { className, triggerClassName, position, trigger, volume } = this.props;
        ...
        //window.onblur = () => {this.setState({ isVolumeShown: !1 }); window.document.querySelector("body").classList.remove(miniplayer.noD);}
